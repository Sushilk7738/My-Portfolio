...
const socials = [
  ...
  {Icon : FaLinkedin, label : 'LinkedIn', href : "https://www.linkedin.com/in/sushil-kamble-137585233/"},
  {Icon : FaGithub, label : 'Github', href : "https://github.com/Sushilk7738"},
]
...
export default function Home(){
  const roles = useMemo(()=> ["Software Developer", "Python Developer"], [])
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
          <div className='w-full lg:pr-24 mx-auto max-w-[48rem]'>
            ...
            <motion.h1 className='text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text
              ...
              Hello, I'm 
              <br />
              <span className='text-white font-bold text-5xl sm:text-6xl lg:text-8xl lg:whitespace-nowrap'>
                Sushil Kamble
              </span>
            </motion.h1>
        ...
        <div className='relative hidden lg:block'>
          ...
          <motion.img src={avator} alt="Sushil Kamble" 
